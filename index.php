...
<!-- Mirrored from colorlib.com/preview/theme/persuit/home-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Jul 2018 10:14:48 GMT -->
...
<head>
        ...
        <link rel="icon" href="img/Vscents.jpg" type="image/x-icon" />
    ...
    <body class="home_sidebar">
        ...
        <div class="home_box">
            ...
            <header class="shop_header_area carousel_menu_area ">
                <div class="carousel_top_header black_top_header row m0 fixed-top">
                    <div class="container">
                    ...
                    <div class="carousel_top_h_inner">
                        ...
                        <div class="float-md-right">
                            <div class="top_header_middle">
                                <a href="#"><i class="fa fa-phone"></i> Call Us: <span>+234 706 500 2030</span></a>
                                <a href="#"><i class="fa fa-envelope"></i> Email: <span><span class="__cf_email__" data-cfemail="5d2e282d2d322f291d2432282f3932303c3433733e3230">[zurielharry@yahoo.com]</span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel_menu_inner">
                    <div class="container">
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="navbar-brand" href="index.php"><!-- <img src="img/logo.png" alt=""> --><h1>Vscents</h1><!-- <span style="font-size: 12px; font-style: italic; padding-bottom: 20px;">Unforgetable</span> --></a>
                            <br>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                 <ul class="navbar-nav mr-auto">
                                     <li class="nav-item dropdown submenu active">
                                        ...
                                        <a href="index.php">Home</a> <i class="fa fa-angle-down" aria-hidden="true"></i>
                                        </a>
                                        <!-- <ul class="dropdown-menu">
                                            <li class="nav-item"><a class="nav-link" href="index-2.html">Home Simple</a></li>
                                    ...
                                    <li class="nav-item dropdown submenu">
                                        <a class="nav-link dropdown-toggle" href="new-arrivals.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <a href="new-arrivals.php">New Arrivals</a> <i class="fa fa-angle-down" aria-hidden="true"></i>
                                        </a>
                                        <!-- <ul class="dropdown-menu">
                        ...
                        <div class="col-lg-9 float-md-right">
                            <div class="sidebar_main_content_area">
                                ...
                                <div class="home_sidebar_blog">
                                    <h3 class="single_title">New Trending</h3>
                                    <div class="row">
                                ...
                                <!--================Start Carousel Area =================-->
                                <br>
                                <h3 class="single_title">Shop by Category</h3>
                                <br>
                                ...
                                <!--================Start Niche Perfume =================-->
                                 <div class="fillter_home_sidebar">
                                    <h3 class="single_title">Niche Perfumes</h3>
                                    <br>
                                    <div class="home_l_product_slider owl-carousel">
                                        <div class="item woman shoes">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                    <a href="product-detail.php"><img src="img/product/fillter-product/f-product-8.jpg" alt=""></a>
                    ...
                    <div class="row row_disable">
                        <div class="col-lg-9 float-md-right">
                            <div class="sidebar_main_content_area">
                                ...
                                <br>
                                <div class="home_sidebar_blog">
                                    <h3 class="single_title">Recommendations for you</h3>
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="img/blog/from-blog/f-blog-4.jpg" alt="">
        ...
        <section class="fillter_product_slider_area">
            <div class="container">
                <div class="fillter_product_inner">
                    ...
                    <h4 style="text-align: center; font-size: 18px; font-weight: 600; font-family: "Poppins", sans-serif; color: #000;">Top Brands</h4>
                     <br>
                ...
                <div class="container">
                    <div class="world_service_inner">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="world_service_item">
                                    <h4><img src="img/icon/world-icon-2.png" alt="">24/7 Help Center</h4>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="world_service_item">
  ...
  Vscents.com.ng <script>document.write(new Date().getFullYear());</script> | All rights reserved 
...
<!-- Mirrored from colorlib.com/preview/theme/persuit/home-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Jul 2018 10:15:11 GMT -->
</html>